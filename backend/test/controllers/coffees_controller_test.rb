...
class CoffeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee" do
    assert_difference('Coffee.count') do
      post coffees_url, params: { coffee: { bean: @coffee.bean, description: @coffee.description, name: @coffee.name } }, as: :json
    end
  ...
  test "should update coffee" do
    patch coffee_url(@coffee), params: { coffee: { bean: @coffee.bean, description: @coffee.description, name: @coffee.name } }, as: :json
    assert_response 200
  end
