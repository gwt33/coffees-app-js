...
class OriginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post origins_url, params: { origin: { country: @origin.country, description: @origin.description, region: @origin.region } }, as: :json
    end
  ...
  test "should update origin" do
    patch origin_url(@origin), params: { origin: { country: @origin.country, description: @origin.description, region: @origin.region } }, as: :json
    assert_response 200
  end
